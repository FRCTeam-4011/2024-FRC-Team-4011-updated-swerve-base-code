  ...
  public shootAmpSCG(ArmSubsystem armSubsystem, ShooterSubsystem shooterSubsystem, KickerSubsystem kickerSubsystem) {
    ...
    addCommands(
      new ParallelCommandGroup(
        new RunShooterCMD(shooterSubsystem, VoltageConstants.vk_TopShooterAmp, VoltageConstants.vk_BottomShooterAmp),//
        new MoveArmToAmpCMD(armSubsystem, VoltageConstants.vk_ArmUp)
      ),//
      //new WaitCommand(1),//
