...
public class RobotContainer {
   ...
   // private final Command FourNoteAuto = new FourNoteAuto(s_Swerve, shooterSubsystem, kickerSubsystem, armSubsystem, intakeAndKickerSubsystem);
    ...
    private void configureButtonBindings() {
        ...
        new JoystickButton(operatorJoystick, 1).onTrue(new IntakeAndKickerCMD(intakeAndKickerSubsystem, VoltageConstants.vk_IntakeForward, VoltageConstants.vk_KickerForward));
       ...
       // new JoystickButton(operatorJoystick, 7).onTrue(new shootMaxRangeSCG(armSubsystem, shooterSubsystem, kickerSubsystem));
        ...
        new JoystickButton(operatorJoystick, 9).whileTrue(new RunShooterCMD(shooterSubsystem, VoltageConstants.vk_TopShooterForward, VoltageConstants.vk_BottomShooterForward));
